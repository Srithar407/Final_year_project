...
/**
 * Servlet implementation class princecircular
 */
@WebServlet("/princecircular")
public class princecircular extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public princecircular() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		n.setFilename(paramValues.get(6).toString());
		System.out.println("File name :"+paramValues.get(6).toString());
